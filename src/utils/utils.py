...
def parsing():
    ...
    parser.add_argument("--path-relevancy", type=str, help="path of the Epic relevancy matrix",
                        default="../data/relevancy") 

    parser.add_argument("--path-model", type=str, help="Path of the saved model",
                        default="../data/models/new_submission")
    ...
    parser.add_argument("--m-video", type=int, help="length of context video",
                        default=3)
    
    parser.add_argument("--m-text", type=int, help="length of context text",
                        default=0)
